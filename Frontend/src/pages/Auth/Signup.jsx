    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm" onClick={() => setShowSignUp(false)}>
      <div className="bg-transparent p-8 rounded-xl w-100 relative border border-white h-130" onClick={(e) => e.stopPropagation()} >
        ...
        <div className='text-white flex flex-col justify-center items-center gap-2'>
          ...
          <h2 className='text-3xl'>SignIn to CapitalIx</h2>
        </div>
        ...
        <h2 className='mt-2 text-center text-white'>Already have a account?<span className='text-[#3a0bf6] hover:cursor-pointer hover:underline'>SignIn</span></h2>
      </div>
    </div>
  )
}
