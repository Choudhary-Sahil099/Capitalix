    ...
    <section id="hero" className='hero-bg w-full min-h-min px-20 flex py-17'>
      <div className='w-1/2 flex flex-col gap-8 pt-10'>
        ...
        <div className='flex gap-7'>
          <button className='hero-bg border border-amber-50 w-50 h-15 text-xl rounded-xl text-white flex justify-center items-center gap-3' onClick={onSignClick}>Open An Account</button>
